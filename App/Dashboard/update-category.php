...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $result = $collection->findById("Category",$id);
}
    ...
    <section class="sherah-adashboard sherah-show">
        <div class="container">
            <div class="sherah-breadcrumb mg-top-30">
                <h2 class="sherah-breadcrumb__title">Sửa thông tin Category</h2>
            </div>
            <div class="row">
                <div class="col-12">
                    <form class="sherah-wc__form-main" enctype="multipart/form-data" action="../Service/addCategory.php" method="Post">
                        <div class="row">
                            ...
                            if(isset($_GET['id'])) {
                                $id = $_GET['id'];
                                $collection = new Database("RestaurantManagement");
                                $category = $collection->findById("Category",$id);
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group__input">
                                                    <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập Category ID" value="<?=$item['category_id']?>" type="text" name="category_id">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group__input">
                                                    ...
                                                    <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập Category" value="<?=$item['name']?>" type="text" name="name">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Product Info -->
                            ...
                            <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                <button type="submit" class="sherah-btn sherah-btn__primary" name="update">Cập nhật</button>
