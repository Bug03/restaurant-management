...
$collecttion = new Database('RestauratnManagement');

$result = $collecttion->findAll('Food');


//if (isset($_POST['addCart']) && !empty($_POST['addCart'])) {
//    $productCart = $collecttion->findById($_POST['addCart']['food_id']); // lấy ra được sản phẩm vừa thêm
//    foreach ($productCart as $product)
//    $_SESSION['cart']['food_id'] = (int) $product['_id'];
//    $_SESSION['cart']['food_id']['name'] = $product['name'];
//    $_SESSION['cart']['food_id']['price'] = $product['price'];
//    $_SESSION['cart']['food_id']['qty'] = $_POST['addCart']['qty'];
//}
...
//    $productCart = $collecttion->findById($_POST['id']);
//    if (!isset($_SESSION['carts']) || empty($_SESSION['carts'])) {
//        $_SESSION['carts'][$id] = $productCart;
							...
							<div class="sherah-dsinner">
								<div class="row">
									<div class="col-12">
										<div class="sherah-breadcrumb mg-top-30">
											<h2 class="sherah-breadcrumb__title">Tạo Đơn Hàng</h2>
											<ul class="sherah-breadcrumb__list">
												<li><a href="#">Home</a></li>
												<li class="active"><a href="upload-order.php">Tạo Đơn Hàng</a></li>
											</ul>
										</div>
									</div>
								</div>
                                ...
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <tr>
                                            <th class="sherah-table__column-1 sherah-table__h1" style="text-align: center">ID</th>
                                            <th class="sherah-table__column-1 sherah-table__h2">Name</th>
                                            <th class="sherah-table__column-2 sherah-table__h3">Price</th>
                                            <th class="sherah-table__column-3 sherah-table__h4">Qty</th>
                                            <th class="sherah-table__column-4 sherah-table__h5">Action</th>
                                        </tr>
                                        </thead>
                                        <tbody class="sherah-table__body" id="list-product">

                                        </tbody>
                                    </table>
                                </div>

                                <!-- Form thêm sản phẩm vào đơn hàng-->
                                <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                    <form class="sherah-wc__form-main" id="post-product" enctype="multipart/form-data" action="" method="Post">
                                        <div class="row">
                                            <div class="col-12">
                                                <!-- Product Info -->
                                                <div class="product-form-box sherah-border mg-top-30">
                                                    <h4 class="form-title m-0">Thêm sản phẩm</h4>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="sherah-wc__form-label">Thêm Sản phẩm</label>
                                                            <div class="form-group__input">
                                                                <select style="color:#333" class="form-group__input" id="product_id" aria-label="Default select example" required  name="product_id">
                                                                    <option value="">Chọn sản phẩm</option>
                                                                    <?php
                                                                    $collecttionProduct = new Database("RestaurantManagement");
                                                                    $products = $collecttionProduct->findAll("Food");
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group__input">
                                                                <input style="color:#333" class="sherah-wc__form-input" id="product_qty" required placeholder="Nhập số lượng sản phẩm" type="text" name="product_qty">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- End Product Info -->
                                            ...
                                            <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                                <button type="submit" class="sherah-btn sherah-btn__primary" name="add_product">Thêm Sản Phẩm Vào Đơn Hàng</button>
                                                <button class="sherah-btn sherah-btn__third">Clear</button>
                                            </div>
                                    </form>
                                </div>
                                </div>
								...
								<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
									<form class="sherah-wc__form-main" enctype="multipart/form-data" action="../Service/addOrder.php" method="Post">
										<div class="row">
											<div class="col-12">
												<!-- Product Info -->
												<div class="product-form-box sherah-border mg-top-30">
													<h4 class="form-title m-0">Thông tin đơn hàng</h4>
													<div class="col-12">
														<div class="form-group">
															<label class="sherah-wc__form-label">ID</label>
															<div class="form-group__input">
																<input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập id đơn hàng" type="text" required name="orderID">
															</div>
														</div>
													</div>
<!--                                                    <div class="col-12">-->
...
<!--                                                            <label class="sherah-wc__form-label">Thêm Sản phẩm</label>-->
<!--                                                            <div class="form-group__input">-->
<!--                                                                <select style="color:#333" class="form-group__input" aria-label="Default select example" name="paymentStatus">-->
<!--                                                                    <option value="">Chọn sản phẩm</option>-->
<!--                                                                    --><?php
//                                                                    $collecttionProduct = new Database("RestaurantManagement");
//                                                                    $products = $collecttionProduct->findAll("Food");
...
//                                                                    foreach ($products as $product) {
//                                                                        ?>
<!--                                                                        <option value="--><?php //=$product['_id']?><!--">--><?php //=$product['name']?><!--</option>-->
<!--                                                                        --><?php
//                                                                    }
//                                                                    ?>
<!--                                                                </select>-->
...
<!--                                                    </div>-->
													<div class="col-12">
														<div class="form-group">
															<label class="sherah-wc__form-label">Tên khách hàng</label>
															<div class="form-group__input">
																<input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tên khách hàng" required type="text" name="customerName">
															</div>
														</div>
													</div>
													<div class="col-12">
														<div class="form-group">
															<label class="sherah-wc__form-label">Ngày</label>
															<div class="form-group__input">
																<input style="color:#333" class="sherah-wc__form-input" placeholder="dd/mm/yy" required type="text" name="date">
															</div>
														</div>
													</div>
													<div class="col-12">
														<div class="form-group">
															...
															<div class="form-group__input">
																<select style="color:#333" class="form-group__input" aria-label="Default select example" required name="paymentStatus">
...
<!--													<div class="col-12">-->
<!--														<div class="form-group">-->
<!--															<label class="sherah-wc__form-label">Tổng tiền (VND)</label>-->
<!--															<div class="form-group__input">-->
<!--																<input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tổng tiền" type="number" name="total">-->
<!--															</div>-->
<!--														</div>-->
<!--													</div>-->
													<div class="col-12">
														<div class="form-group">
															<label class="sherah-wc__form-label">Phương thức thanh toán</label>
															<div class="form-group__input">
																<select style="color:#333" class="form-group__input" aria-label="Default select example" required name="paymentMethod">
													...
													<div class="col-12">
														<div class="form-group">
															<label class="sherah-wc__form-label">Trạng thái đơn hàng</label>
															<div class="form-group__input">
																<select style="color:#333" class="form-group__input" aria-label="Default select example" required name="orderStatus">
																	<option selected value="Đã giao">Shipped</option>
																	<option value="Chưa giao">Unshipped</option>
																</select>
															</div>
														</div>
													</div>
											...
											<div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
												<button type="submit" class="sherah-btn sherah-btn__primary" name="create">Tạo Đơn Hàng Mới</button>
...
<!---->
<!--            // Sử dụng hàm data() để lưu trữ giá trị trên từng phần tử-->
<!--            $this.data('quantity', Number($this.val()));-->
<!---->
<!--            $(qty).on('click', function () {-->
<!--                var currentQty = $this.data('quantity');-->
<!---->
<!--                if ($(this).hasClass('minus')) {-->
<!--                    if (currentQty > min) currentQty += -1;-->
<!--                } else if ($(this).hasClass('plus')) {-->
<!--                    var x = currentQty + 1;-->
<!--                    if (x <= max) currentQty += 1;-->
<!--                }-->
<!---->
<!--                $this.data('quantity', currentQty);-->
<!--                $this.val(currentQty);-->
<!---->
<!--                let danh = $this.attr('name');-->
<!--                let string = danh.match(/\[([^\]]+)\]/);-->
<!--                let product_id = string && string[1];-->
<!--                updateSessionData(product_id, $this.attr('value'));-->
<!--            })-->
<!--        })-->
<!--    </script>-->
    <!-- updateSessionData   -->
...
<!--    </script>-->
    ...
    <script>
        ...
        $(document).on('click', 'tr[data-product-id]', function() {
            // Lấy thông tin từ hàng được chọn
            var productId = $(this).data('product-id');
            // var productName = $(this).find('.sherah-table__product-desc').eq(1).text(); // Thay index này nếu cần
...
<!--                   }-->
<!--               }-->
<!--               alert("Current Quantity:", currentQty);-->
<!--               alert("Min:", min);-->
<!--               alert("Max:", max);-->
<!---->
<!--               $this.data('quantity', currentQty);-->
