...
$result = $collection->findAll("Users");
                        ...
                        <div class="sherah-dsinner">
                                ...
                                <div class="col-12">
                                    <div class="sherah-breadcrumb mg-top-30">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><a href="customer-list.html">Admin List</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                    ...
                                    <tr>
                                        <th class="sherah-table__column-2 sherah-table__h2">First name</th>
                                        <th class="sherah-table__column-3 sherah-table__h3">Last name</th>
                                        <th class="sherah-table__column-4 sherah-table__h4">Email</th>
                                        <th class="sherah-table__column-5 sherah-table__h5">Phone Number</th>
<!--                                        <th class="sherah-table__column-7 sherah-table__h6">Password</th>-->
                                    ...
                                    <tr>
                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                            <div class="sherah-table__product">
                                                ...
                                                <!--                                                                    </div>-->
                                                <h4 class="sherah-table__vendor--title"><?=$rs['Firstname']?></h4>
                                            </div>
                                        </td>
                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                            <div class="sherah-table__product-content">
                                                <p class="sherah-table__product-desc"><?=$rs['Lastname']?></p>
                                            </div>
                            </div>
                            </td>
                            <td class="sherah-table__column-4 sherah-table__data-4">
                                <div class="sherah-table__product-content">
                                    <p class="sherah-table__product-desc"><?=$rs['Email']?></p>
                                </div>
                            </td>
                            <td class="sherah-table__column-5 sherah-table__data-5">
                                <div class="sherah-table__status sherah-color2 sherah-color2__bg--opactity"><?=$rs['Phone Number']?></div>
                            </td>
<!--                            <td class="sherah-table__column-6 sherah-table__data-6">-->
<!--                                <div class="sherah-table__product-content">-->
<!--                                    <p class="sherah-table__product-desc">--><?php //=$rs['Password']?><!--</p>-->
<!--                                </div>-->
<!--                            </td>-->
                            <td class="sherah-table__column-7 sherah-table__data-7">
                                <div class="sherah-table__status__group">
                                    <a href="update-admin.php?id=<?=$rs['_id']?>" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                    ...
                                    <a href="../Service/deleteAdmin.php?id=<?=$rs['_id']?>" class="sherah-table__action sherah-color2 sherah-color2__bg--offset confirmation">
