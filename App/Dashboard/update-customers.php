...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $result = $collection->findById("Customer",$id);
}
...
<html class="no-js" lang="zxx">
	...
	<body id="sherah-dark-light">
		...
		<div class="sherah-body-area">
            ...
            <?php
            $collection = new Database("RestaurantManagement");
            $user = $collection->findById('Customer',$_GET['id']);
			...
			<section class="sherah-adashboard sherah-show">
				<div class="container">
                    <div class="sherah-breadcrumb mg-top-30">
					    <h2 class="sherah-breadcrumb__title">Sửa thông tin User</h2>
                    </div>
					<div class="row">
						<div class="col-12">
                            <form class="sherah-wc__form-main" enctype="multipart/form-data" action="../Service/updateUser.php" method="Post">
                                <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group__input">
                                                        ...
                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tên đầu" value="<?=$item['Firstname']?>" type="text" name="Firstname">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group__input">
                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tên cuối" value="<?=$item['Lastname']?>" type="text" name="Lastname">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group__input">
                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập email" value="<?=$item['Email']?>" type="email" name="Email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group__input">
                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập số điện thoại"  value="<?=$item['Phone Number']?>" type="text" name="Phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group__input">
                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập mật khẩu" value="<?=$item['Password']?>" type="password" name="Password">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                        <button type="submit" class="sherah-btn sherah-btn__primary" name="update">Cập nhật tài khoản</button>
                                       <a href="./user-list.php"> <button type="button" class="sherah-btn sherah-btn__third">Cancel</button></a>
                                    </div>
                            </form>
						</div>
					</div>
