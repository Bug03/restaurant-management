...
if (!isset($_SESSION['Firstname'])) {
    ...
    $result = $collection->findById("Food",$id);

    //$count =iterator_count($result);
?>
<!DOCTYPE html>
...
<li><a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__category"><span class="menu-bar__text">
									<span class="sherah-menu-icon sherah-svg-icon__v1">
										<svg class="sherah-svg-icon"  xmlns="http://www.w3.org/2000/svg" width="21.732" height="18" viewBox="0 0 21.732 18">
											<g id="Icon" transform="translate(-525.662 -352.927)">
											  <path id="Path_208" data-name="Path 208" d="M536.507,455.982q-4.327,0-8.654,0a1.953,1.953,0,0,1-2.188-2.2c0-.99-.005-1.979,0-2.969a3.176,3.176,0,0,1,3.309-3.315c.875,0,1.749.052,2.624.062a.451.451,0,0,0,.33-.168,3.237,3.237,0,0,1,2.94-1.527q1.654.024,3.309,0a3.262,3.262,0,0,1,2.947,1.52.621.621,0,0,0,.449.153,30.091,30.091,0,0,1,3.212.044,3.044,3.044,0,0,1,2.594,3.014c.021,1.117.014,2.234.005,3.351a1.909,1.909,0,0,1-2.054,2.032Q540.919,455.989,536.507,455.982Zm3.812-1.288c0-.187,0-.326,0-.465-.008-1.781.026-3.564-.042-5.342a1.8,1.8,0,0,0-1.929-1.74c-1.131-.012-2.263,0-3.394,0a1.961,1.961,0,0,0-2.22,2.212q0,2.439,0,4.878v.46Zm-8.89.011c.013-.11.026-.165.026-.22,0-1.781-.006-3.562.009-5.343,0-.337-.178-.37-.422-.37-.749,0-1.5-.024-2.248.006a1.849,1.849,0,0,0-1.837,1.763c-.044,1.172-.022,2.346-.013,3.519a.581.581,0,0,0,.6.639C528.826,454.716,530.111,454.705,531.429,454.705Zm10.165-.005c1.354,0,2.664.018,3.974-.011.377-.008.544-.315.544-.688,0-1.117.017-2.234-.007-3.35a1.867,1.867,0,0,0-1.823-1.87c-.762-.035-1.526,0-2.29-.01-.3,0-.41.114-.406.431.017,1.4.007,2.8.007,4.2Z" transform="translate(0 -85.056)"/>
									...
									<!-- Dropdown Menu -->
									<div class="collapse sherah__dropdown" id="menu-item__category"  data-bs-parent="#sherahMenu">
										<ul class="menu-bar__one-dropdown">
											<li><a href="category-list.php"><span class="menu-bar__text"><span class="menu-bar__name">Categories</span></span></a></li>
											<li><a href="upload-category.php"><span class="menu-bar__text"><span class="menu-bar__name">New Category</span></span></a></li>
										</ul>
									</div>
								</li>
								<li><a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_products"><span class="menu-bar__text">
									...
									<div class="collapse sherah__dropdown" id="menu-item_products" data-bs-parent="#sherahMenu">
										<ul class="menu-bar__one-dropdown">
											...
											<li><a href="product-details.html"><span class="menu-bar__text"><span class="menu-bar__name">Product Details</span></span></a></li>
									...
									<div class="row mg-top-30">
										<div class="col-12 sherah-flex-between">
											...
											<div class="sherah-breadcrumb">
												<h2 class="sherah-breadcrumb__title">Chi tiết Sản Phẩm</Details></h2>
												<ul class="sherah-breadcrumb__list"> 
													<li><a href="#">Home</a></li>
													<li class="active"><a href="products.php">Chi tiết Sản Phẩm</a></li>
												</ul>
											</div>
                                            <a href="./update-product.php?id=<?=$_GET['id']?>" class="sherah-btn sherah-gbcolor">Cập nhật sản phẩm</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="product-detail-body__content">
                                                    <h2 class="product-detail-body__title"><?=$rs['name']?></h2>
                                                    <div class="product-detail-body__deal--rating">
                                                        <?= sprintf(' <h5 class="sherah-product-card__price">%s VND</h5>', number_format($rs['price'], 0, '', ','))?>
                                                    </div>
                                                        ...
                                                        <div class="sherah-button-group">
                                                            <div class="quantity">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[1]" class="input-number"  data-min="1" data-max="10" value="0">
                                                            ...
                                                            <a href="#" class="sherah-btn default">
                                                                <svg class="sherah-default__fill sherah-default__heart" xmlns="http://www.w3.org/2000/svg" width="21.559" height="19.349" viewBox="0 0 21.559 19.349">
                                                                    <path id="Path_533" data-name="Path 533" d="M111.852,15.093v.924a1.034,1.034,0,0,0-.03.135,7.2,7.2,0,0,1-1.211,3.339,14.326,14.326,0,0,1-2.5,2.868c-1.887,1.684-3.8,3.337-5.713,4.994a1.2,1.2,0,0,1-1.7-.04q-2.192-1.885-4.378-3.777a22.751,22.751,0,0,1-3.411-3.5,7.509,7.509,0,0,1-1.514-3.347,6.362,6.362,0,0,1,1.4-5.335,5.368,5.368,0,0,1,5.028-1.9,5.245,5.245,0,0,1,3.221,1.768c.184.2.352.414.539.635.092-.119.171-.225.255-.327s.18-.216.277-.318a5.235,5.235,0,0,1,5.72-1.543,5.583,5.583,0,0,1,3.813,4.222C111.746,14.284,111.784,14.692,111.852,15.093Z" transform="translate(-90.794 -8.871)" stroke-width="1"></path>
                                                                </svg>
                                                            </a>
                                                            <a href="#" class="sherah-btn default">
...
<!--                                                            <li><span class="p-list-title">Tags :</span> Grown Dress, Dress, Party Dress </li>-->
<!--                                                            <li>-->
<!--                                                                <span class="p-list-title">Share:</span> -->
<!--                                                                <ul class="sherah-contact-info sherah-contact-social">-->
<!--                                                                    <li class="sherah-border"><a href="#"><span class="sherah-color1__bg--offset"><i class="fa-brands fa-facebook-f"></i></span></a></li>-->
<!--                                                                    <li class="sherah-border"><a href="#"><span class="sherah-color1__bg--offset"><i class="fa-brands fa-twitter"></i></span></a></li>-->
<!--                                                                    <li class="sherah-border"><a href="#"><span class="sherah-color1__bg--offset"><i class="fa-brands fa-linkedin"></i></span></a></li>-->
<!--                                                                    <li class="sherah-border"><a href="#"><span class="sherah-color1__bg--offset"><i class="fa-brands fa-instagram"></i></span></a></li>-->
<!--                                                                </ul>-->
<!--                                                            </li>-->
<!--                                                        </ul>-->
<!--                                                    </div>-->
