									...
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Cập Nhật Món Ăn</h2>
												<ul class="sherah-breadcrumb__list">
													<li><a href="#">Home</a></li>
													<li class="active"><a href="profile-info.html">Cập Nhật Món Ăn</a></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" enctype="multipart/form-data" action="../Service/updateProduct.php" method="Post">
                                            <div class="row">
                                                <div class="col-12">
                                                    <?php
                                                    foreach($result as $rs)
                                                        ...
                                                        <h4 class="form-title m-0">Thông tin món ăn</h4>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        ...
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tên món ăn" type="text" value="<?=$rs['name']?>" name="name">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập giá món ăn" type="number" value="<?=$rs['price']?>" name="price">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea style="color:#333" class="form-control" id="exampleFormControlTextarea1" name="description" rows="3"><?=$rs['description']?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="sherah-wc__form-label">Hình ảnh món ăn</label>
                                                                     <div class="form-group__input">
                                                                         <input type="hidden" name="file_tmp" value="<?=$rs['fileName']?>">
                                                                        <input style="padding:15px" type="file" class="form-control-file" name="file"> <span><?=$rs['fileName']?></span>
                                                                     </div>
                                            ...
                                            <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                                <button type="submit" class="sherah-btn sherah-btn__primary" name="update">Cập Nhật Món Ăn</button>
