									...
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Tạo Người Dùng Mới</h2>
												<ul class="sherah-breadcrumb__list"> 
													<li><a href="#">Home</a></li>
													<li class="active"><a href="profile-info.html">Tạo Người Dùng Mới</a></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" enctype="multipart/form-data" action="../Service/updateUser.php" method="Post">
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        <h4 class="form-title m-0">Thông tin tài khoản</h4>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">First name</label>
                                                                    <div class="form-group__input">
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tên đầu " type="text" name="Firstname">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập tên cuối" type="text" name="Lastname">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập email" type="email" name="Email">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập số điện thoại" type="text" name="Phone">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input style="color:#333" class="sherah-wc__form-input" placeholder="Nhập mật khẩu" type="password" name="password">
                                                                    </div>
                                                                </div>
                                                            </div>
<!--                                                            <div class="col-12">-->
<!--                                                                <div class="form-group">-->
<!--                                                                    <label class="sherah-wc__form-label">Role*</label>-->
<!--                                                                    <select style="color:#333" class="form-group__input" aria-label="Default select example" name="role">-->
...
<!--                                                            </div>-->
                                            ...
                                            <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                                <button type="submit" class="sherah-btn sherah-btn__primary" name="create">Tạo tài khoản mới</button>
