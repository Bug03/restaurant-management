...
$result = $collection->findAll("Category");
									...
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    <th class="sherah-table__column-2 sherah-table__h1">Category ID</th>
                                                    <th class="sherah-table__column-3 sherah-table__h2">Name</th>
<!--                                                    <th class="sherah-table__column-9 sherah-table__h3"></th>-->
                                                    <th class="sherah-table__column-9 sherah-table__h3">Action</th>
                                                </tr>
                                            </thead>
...
<!--                                                                    </div>-->
                                                                    <h4 class="sherah-table__vendor--title"><?=$rs['category_id']?></h4>
                                                                </div>
                                                            </td>
                                                            <td class="sherah-table__column-2 sherah-table__data-2">
                                                                <div class="sherah-table__product-content">
                                                                    <p class="sherah-table__product-desc"><?=$rs['name']?></p>
                                                                </div>
                                                                </div>
                                                            </td>
                                                            <td class="sherah-table__column-3 sherah-table__data-3">
                                                                <div class="sherah-table__status__group">
                                                                    <a href="update-category.php?id=<?=$rs['_id']?>" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                                    ...
                                                                    <a href="../Service/deleteCategory.php?id=<?=$rs['_id']?>" class="sherah-table__action sherah-color2 sherah-color2__bg--offset confirmation">
