...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $id = $_GET['id'];
    $result = $collection->findById("Order", $id);
}
                        ...
                        <div class="sherah-dsinner">
                                ...
                                <div class="col-12 sherah-flex-between">
                                    ...
                                    <div class="sherah-breadcrumb">
                                        ...
                                        <ul class="sherah-breadcrumb__list">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><a href="order-details.php">Order Details</a></li>
                                        </ul>
                                    </div>
                                    <!-- End Sherah Breadcrumb -->
                                    <a href="upload-order.php" class="sherah-btn sherah-gbcolor">Tạo đơn hàng mới</a>
                                </div>
                            </div>
                            <div class="sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                <div class="sherah-table__head sherah-table__main">
                                    ...
                                    $totalQuantity = 0;
                                    $orderValue = 0;
                                    foreach ($rs['foods'] as $product) {
                                        // Đặt lại giá trị cho mỗi sản phẩm
                                        $quantity = (int)$product['quantity'];
                                        $productValue = (int)$product['quantity'] * (int)$product['price'];
                                    ...
                                    // Cộng vào tổng giá trị đơn hàng cuối cùng
                                    $totalOrderValue += $orderValue;

                                    ?>
                                    <h4 class="sherah-order-title">Chi tiết đơn hàng <?= $rs['orderID'] ?> </h4>
                                    <div class="sherah-order-right">
                                        <p class="sherah-order-text"> <?= $rs['date'] ?> - <?= $totalQuantity ?> món - Tổng <?= $totalOrderValue ?> VND</p>
                                        <div class="sherah-table-status">
                                            <?php
                                            if ($rs['paymentStatus'] == 'Paid') {
                                                ?>
                                                <div class="sherah-table__status sherah-color3 sherah-color3__bg--opactity">Đã thanh toán</div>
                                                <?php
                                            } else if ($rs['paymentStatus'] == 'UnPaid'){
                                                ?>
                                                <div class="sherah-table__status sherah-color2 sherah-color2__bg--opactity">Chưa thanh toán</div>
                                                <?php
                                            }
                                            ?>
                                        </div>
                                    ...
                                    <div class="col-12 mg-top-30">
                                        <div class="sherah-table-order">
                                            <table id="sherah-table__orderv1" class="sherah-table__main sherah-table__main--orderv1">
                                                ...
                                                <tr>
                                                    <th class="sherah-table__column-1 sherah-table__h1">Tên món ăn</th>
                                                    <th class="sherah-table__column-2 sherah-table__h2">Đơn giá</th>
                                                    <th class="sherah-table__column-3 sherah-table__h3">Số lượng</th>
                                                    ...
                                                    <tr>
                                                        <td class="sherah-table__column-1 sherah-table__data-1">
                                                            <div class="sherah-table__product">
                                                                <p class="sherah-table__product-desc"><?= $product['foodName'] ?></p>
                                                            </div>
                                                        </td>
                                                        <td class="sherah-table__column-2 sherah-table__data-2">
                                                            <div class="sherah-table__product-content">
                                                                <p class="sherah-table__product-desc"><?= $product['price'] ?> VND</p>
                                                            </div>
                                                        </td>
                                                        <td class="sherah-table__column-3 sherah-table__data-3">
                                                            <div class="sherah-table__product-content">
                                                                <p class="sherah-table__product-desc"><?= $quantity ?></p>
                                                            </div>
                                                        </td>
                                                        <td class="sherah-table__column-4 sherah-table__data-4">
                                                            <div class="sherah-table__product-content">
                                                                <p class="sherah-table__product-desc"><?= $productValue ?> VND</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php
                                ...
                                <div class="order-totals">
                                    <p class="order-totals__bottom"><span>Tổng tiền</span> <span class="order-totals__amount"> <?= $totalOrderValue ?> VND</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
