...
<div class="sherah-body-area">
    ...
    <section class="sherah-adashboard sherah-show">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="sherah-wc__form-main p-0" action="../Service/updateUser.php" method="POST">
                        <?php
                        foreach($result as $rs) {
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group__input">
                                    <input style="color:#333" class="sherah-wc__form-input" type="text" name="name" value="<?=$rs['name']?>" required="required">
                                </div>
                            </div>
                            <input type="hidden" name="id" value="<?=$rs['_id']?>">

                            <!-- Form Group -->
                            <div class="form-group">
                                <label class="sherah-wc__form-label">Số điện thoại</label>
                                <div class="form-group__input">
                                    <input style="color:#333" class="sherah-wc__form-input" type="text" name="phone" value="<?=$rs['phone']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="sherah-wc__form-label">Email</label>
                                <div class="form-group__input">
                                    <input style="color:#333" class="sherah-wc__form-input" type="email" name="email" value="<?=$rs['email']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="sherah-wc__form-label">UserName</label>
                                <div class="form-group__input">
                                    <input style="color:#333" class="sherah-wc__form-input" type="text" name="username" value="<?=$rs['username']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="sherah-wc__form-label">Address</label>
                                <div class="form-group__input">
                                    <input style="color:#333" class="sherah-wc__form-input" type="text" name="address" value="<?=$rs['address']?>">
                                </div>
                            </div>
                            <?php
                        }
                        ...
                        <div class="form-group form-mg-top25">
                            <div class="sherah-wc__button sherah-wc__button--bottom">
                                <button class="ntfmax-wc__btn" type="submit">Cập nhật</button>
                            </div>
                        </div>
                        <!-- Form Group -->
                        <div class="form-group mg-top-20">
                            <div class="sherah-wc__bottom">
                                <p class="sherah-wc__text"><a href="user-list.php">Quay lại <-</a></p>
                            </div>
                        </div>
                    </form>
                </div>
