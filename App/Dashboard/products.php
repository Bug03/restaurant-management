...
//////$result = $collection->findAll("Food"); //
//$result = $collection->findLimit("Food",5,0);
							...
							<div class="sherah-dsinner">
								...
								<div class="row mg-top-30">
									<div class="col-12 sherah-flex-between">
										...
										<a href="./upload-product.php" class="sherah-btn sherah-gbcolor">Thêm sản phẩm</a>
									</div>
...
<!--										</div>-->
										<div class="sherah-breadcrumb__right--first">
											<div class="sherah-header__form sherah-header__form--product col-xxl-4 col-lg-6 col-md-6 col-12">
												<form class="sherah-header__form-inner" method="post" id="search-form" action="../Service/search.php">
<!--													<input name="search" type="text" placeholder="Search">-->
                                                        <div class="row">
                                                            <div class="col-lg-9">
                                                                <input type="search" class="form-control form-control-sm" placeholder="Search..." name="search" type="submit">
                                                                <button style="top: -21%" class="search-btn" type="submit">
                                                                    <svg width="15" height="20" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <div class="col-lg-6-9">
                                                                <select style="color:#000;background-color: #fff ;margin-top:10px" class="form-group__input" aria-label="Default select example" name="filter">
	...
	<script>
		$(document).ready(function() {
			// Gọi hàm fetch_data mà không truyền tham số
			fetch_data();
		});
